...
declare function createSerializer<Parsers extends Record<string, ParserWithOptionalDefault<any>>>(parsers: Parsers, { clearOnDefault, urlKeys }?: Pick<Options, 'clearOnDefault'> & {
    ...
    (values: Partial<inferParserType<Parsers>>): string;
    (base: Base, values: Partial<inferParserType<Parsers>> | null): string;
};
...
declare type inferSingleParserType<Parser> = Parser extends ParserBuilder<infer Type> & {
...
export declare function NuqsTestingAdapter(props: TestingAdapterProps): FunctionComponentElement<ProviderProps<AdapterContext>>;
